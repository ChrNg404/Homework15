  ...
  // @TODO: Use `d3.json` to fetch the sample data for the plots
    ...
    // otu_ids, and labels (10 each).
        d3.json(bio).then(function (sampleData) {
            ...
            var pie_hover = sampleData.otu_labels.slice(0,10);
